...
// import { geojson } from '@assets/data/py-departments-geojson'
import paraguayGeojson from '@/assets/data/paraguay.json'
import { pyDepartmentsData } from '@/assets/data/py-departments-data'
